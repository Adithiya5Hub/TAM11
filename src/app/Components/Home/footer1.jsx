...
<div className="flex justify-content space-x-5 justify-center gap-20">
  <div className="flex justify-center space-x-5 gap-20">
    ...
    <a href="https://forms.gle/AahAmRswoEduns928" target="_blank" rel="noopener noreferrer">
        <img src="https://cdn-icons-png.flaticon.com/128/2991/2991110.png" className='h-10 w-10 hover:scale-125' /> HEAD
    </a>  
  </div>
</div>
